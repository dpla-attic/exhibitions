(function($) {
  ...
  $('.search-btn').click(function(e) {
    ...
    $('.searchRowRight form').show().animate({
      width: '98%'
    }, 500, function() {
  ...
  if($('.timeline').length) {
    ...
    $('.bars li').each(function() {
      $(this).css({
        'margin-right': '-100%',
        'margin-left': (0.906343 * barsCount) + '%'
      });
    ...
    $('.graph li').each(function() {
      $(this).css({
        'margin-right': '-100%',
        'margin-left': (0.098038 * graphCount) + '%'
      });
    ...
    $('.DecadesDates li').each(function() {
      $(this).css({
        'margin-right': '-100%',
        'margin-left': (0.980392 * decadesCount - 0.47) + '%'
      });
