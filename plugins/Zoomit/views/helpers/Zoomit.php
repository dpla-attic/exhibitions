...
/**
 * @package Zoomit\View\Helper
 */
class Zoomit_View_Helper_Zoomit extends Zend_View_Helper_Abstract
{
    protected $_supportedExtensions = array('bmp', 'gif', 'ico', 'jpeg', 'jpg', 
                                            'png', 'tiff', 'tif');
    
    /**
     * Return a Zoom.it image viewer for the provided files.
     * 
     ...
     * @return string|null
     */
    public function zoomit($files, $width = 500, $height = 600)
    {
        if (!is_array($files)) {
            $files = array($files);
        }
        ...
        return $this->view->partial('common/zoomit.php', array(
